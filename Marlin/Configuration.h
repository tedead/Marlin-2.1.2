...
#define STRING_CONFIG_H_AUTHOR "tedead" // Who made the changes.
...
#define DEFAULT_EJERK    10.0 //5.0  // May be used by Linear Advance
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.054 //0.08 // (mm) Distance from real junction edge
